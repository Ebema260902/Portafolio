...
const SkillsCard = ({ language }) => {
  const devSkills = ['JavaScript', 'PHP', 'C#', 'React', 'Next.js', 'Laravel', 'TailwindCSS', 'Bootstrap', 'ASP.NET', 'WordPress', 'Git', 'GitHub', 'EC2', 'Vercel', 'Pantheon', 'SQL Server', 'MySQL', 'Selenium'];
  const designSkills = ['UX/UI', 'Figma', 'Photoshop', 'Illustrator'];
  ...
  return (
    <div className="rounded-2xl bg-neutral-900 border border-neutral-800 p-6 flex flex-col gap-5">
      ...
      <div>
        <p className="text-[9.5px] font-bold tracking-[0.14em] uppercase text-neutral-600 mb-2">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-white/[0.03] hover:bg-white/[0.07] border border-white/[0.07] text-[10.5px] font-bold tracking-[0.14em] text-neutral-300 font-mono transition-colors"
      >
        <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor">
